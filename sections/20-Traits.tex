...
Choose a patron: you know what they want and can use \textbf{one} of their spells and \textbf{one} cantrip.
...
\begin{itemize}[nosep, leftmargin=*]
    ...
    \item \textbf{Improve} this pool by learning new spells. Each time you succeed in that add an additional \texttt{d6} to it. Pool can't be larger than half of your \texttt{Clarity}, rounded up.
\end{itemize}
}
...
On fail treat as you rolled zeros on all weapon dice dice.
