\pagetopsection{ Thaliat, the laughing spirit}
...
\begin{itemize}[nosep, leftmargin=*]
 ...
 In combat, it means that for the remainder of it, when you can use \texttt{Deny}. If you already can use it --  an additional die of your choice is discarded.
