\pagetopsection{Lasting damage \& Healing}

\tikz[remember picture,overlay] \node[opacity=1,inner sep=0pt] at (page cs:0.5,-0.35){\includegraphics[width=0.5\paperwidth]{media/healing-cropped-0.png}};
...
Each \textbf{untreated} \texttt{Injury} comes with \texttt{Affliction}, see p.\pageref*{sec:affliction}.
