...
Each time a spell is weaved in combat caster needs to pass \texttt{Clarity Save} or become \texttt{Fatigued}. \textbf{No spell} can be cast until \texttt{Fatigue} is cleared.
