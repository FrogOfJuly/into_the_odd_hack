...
\paragraph{Shields.} Takes one hand, gives one point in armour, common to find. It has \texttt{d4} weapon die.

Spiked shields are uncommon and turn that die into \texttt{d6}.

\subsection*{Consumables}

Those are rare and hard to come by. One usually acquires such items as favours from skilled professionals.
