...
\begin{enumerate}[nosep, leftmargin=*]
    ...
    \item Roll for \texttt{Affliction}(see p.\pageref*{sec:affliction}) and record it
\end{enumerate}
}
...
\subsection*{Scars} Each time a knight sustains \texttt{Damage} that reduced their \texttt{Guard} to zero with overspill into \texttt{Vigor} they gain a \texttt{Scar}.
...
\texttt{Trauma} counts as a \texttt{Severe Injury} and can potentially cause a heart attack and kill a knight if they are out of \texttt{Injury Slots}. 
