...
\begin{multicols*}{2}
    ...
    This is a resource for the Referee, not knights.

    When a hostile NPC wants to use \texttt{Stress} -- Referee can spend \texttt{Fear} of the Company instead of NPCs \texttt{Stress}. 
    ...
    The damage of the attack after \emph{Riposte} modification bypasses your guard.
