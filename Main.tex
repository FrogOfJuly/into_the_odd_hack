...
\paragraph{Guard.} Roll \texttt{2d4} to determine the maximum \texttt{Guard} the knight has.
...
\subsection*{Scars} Each time a knight sustains \texttt{Damage} to \texttt{Vigor} that does not reduce their \texttt{Guard} they gain a \texttt{Scar}.
...
\begin{center}
  ...
  \label{scars}
    \begin{tabular}{|c|p{5.7cm}|}
        ...
        \texttt{2} & A permanent mark. If your max \texttt{GD} is \texttt{2} or less, increase it by \texttt{d6}. \\
        \texttt{3} & A sudden spray of blood, Lose \texttt{d6} \texttt{Vigor}.\\
        ...
        \texttt{5} & Innards pierced and compressed, Lose \texttt{2d6} \texttt{Vigor}.\\
        \texttt{6} & Flesh torn from bone. When you get stitched up, if your max \texttt{GD} is \texttt{6} or less, increase it by \texttt{d6}.\\
        \texttt{7} & A heavy blow numbs the mind, Lose \texttt{2d6} \texttt{Clarity}.\\
        \texttt{8} & Something taken in violent struggle. When you get patched up, if your max \texttt{GD} is \texttt{8} or less, increase it by \texttt{d6}.\\
        \texttt{9} & With a crack, a torturous break, Lose \texttt{2d6} \texttt{Spirit}.\\
        \texttt{10} & A limb rendered useless. If your max \texttt{GD} is \texttt{10} or less, increase it by \texttt{d6}. \\
        \texttt{11} & Death searches for you. Gain \texttt{2} \texttt{Stress}. \\
...
Additionally, if you can heal an \texttt{Injury} by some means, you can't deal with \texttt{Trauma} by those means unless its explicitly allowed.
