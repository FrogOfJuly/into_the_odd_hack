...
\begin{multicols*}{2}
    ...
    Any time a hostile NPCs want to use \texttt{Stress} -- Referee can decide that they spend \texttt{Fear} of the Company as if they were gaining \texttt{Stress}. 
    NPCs don't acquire \texttt{Trauma}s how much it is suitable to spend is on Referee.
    ...
    Hope is also a property of the Company, so it also persistents. 
    ...
    \paragraph{Riposte} is a risky and potentially deadly manoeuvre. If you choose to \emph{Riposte} you use it instead of \texttt{Deny Feat}. 
    Roll your weapon dice as if you are performing an attack. 
    Choose the amount equal to Focus that you allocated to \emph{Defense}, spending one point per dice.
    
    You can match any of your dice with lower dice in the attack roll against you. 
    Deal damage equal to the sum of pairwise difference between matched dice. Discard enemy dice that were matched. 
    The damage of the changed attack against you bypasses your guard.
