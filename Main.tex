...
The first hour allows to a knight to reset their \texttt{Focus} to \texttt{4}, the second -- to \texttt{2}, and the thrid one -- to \texttt{1}. 
...
\paragraph{Stress} is reduced by \texttt{1} each time a knight sleeps full night, \textbf{Focus} can be restored to \texttt{3}.
