...
Each untreated \texttt{Severe Injury} comes with \texttt{Affliction} according to the table below. 
...
\begin{itemize}
    ...
    \item [\ding{108}] \textbf{Remember your fears.} Let the presence of Aestur posses you for a split second to project power and danger. 
...
The spell lasts until you sleep or fall unconscious.

\paragraph{The one that is not there.} Pick any amount of dice, then pick a die with value equal to amount dice picked before it. 
Until the spell ends one can't form memories about you. You can't be targeted by attacks or spells and your attacks ignore \texttt{Guard}.
You can only attack alone, but your attacks ignore \texttt{Guard}.

The spell breaks if amount of creatures that would perceive you without it surpasses the amount of dice you picked for this spell minus one.
Spell lasts 15 minutes for each dice you picked for it.

\paragraph{The one bottling tears.} You touch a victim and a jar. Pick any amount of dice that sum to target's \texttt{Vigor}. 
