...
\begin{itemize}
    ...
    If you rolled \textbf{6} on this damage die -- you mortally wound(p.\pageref*{sec:hopefear}) your victim or deliver one \texttt{Severe Injury}.
    ...
    In combat, until your next turn treat incoming attack as if you allocated an additional \texttt{Focus} to your \emph{Defense}(p.\pageref*{sec:basic}).
\end{itemize}
...
\begin{itemize}
    ...
    Those in immediate vicinity of you who did not expect that do \texttt{Spirit} save and have their attacks impaired if failed.
    \item [\ding{108}] \textbf{This is mine now.} Turn a non-living palm-sized object you touch into solid pure iron. Fine details can't be preserved, e.g. lock will stop working if you alter it like that.
