...
\paragraph{Light.} Pick one die, if its odd -- treat it as if you haven't cast this spell.
You create an immaterial sphere of pale blue light roughly the size of your eyeball. 
...
\paragraph{Wisper.} Pick one die, if its even -- treat it as if you haven't cast this spell.
You whisper a message to the target you can see. It hears you as if inside their ear. 
...
\paragraph{Blade Ward.} Pick any number of dice, mark them as spent, but they can't go back to the pool while the spell lasts.
