...
Usually it makes sense to limit the starting equipment(p. \pageref*{sec:gear}) to be common rarity with a single uncommon item as a prized possession of your knight.
...
\begin{multicols*}{2}
    ...
    Hope does not persistent across fights and scenes, knights should convert it to \texttt{Focus} for themselves or their \texttt{NPCs}.
