...
At the end of that turn, mark all \texttt{Focus} allocated for the defense as spent.
...
\begin{multicols*}{2}
    ...
    Deal damage equal to the sum of pairwise differences between matched dice. Discard enemy dice that were matched. 
...
\begin{enumerate}[nosep, leftmargin=*]
    ...
    % Might be too punishing if not allowed
...
\paragraph{Strength in suffering.} When you attack, upface a die if you have at least one \texttt{Injury Slot} filled.
