...
\begin{itemize}[nosep]
    \item[\ding{170}] If a knight lost \texttt{5, 6, 7, 8, or 9} \texttt{Vigor} through \texttt{Damage} -- take a \texttt{Severe Injury}.
...
\begin{itemize}[nosep]
 ...
 In combat, it means that for the remainder of the combat, when you are attacked, the die of your choice is discarded.
...
One can find additions to internal mouth structure or low back growths.

\begin{itemize}[nosep]
    \item Once per combat, you spit venom out of your mouth. It is quick and unexpected: add a \texttt{d8} \texttt{Weapon die} to the \texttt{Attack}.
...
\begin{multicols*}{2}
    ...
    \begin{itemize}[nosep]
        ...
        \item It has \texttt{1} \texttt{Vigor}, \texttt{0} Armour, but otherwise keeps your parameters.
              Physical \texttt{Damage} applies to you the same, but is targets \texttt{Spirit} instead of \texttt{Vigor}.
        ...
        \item You don't do physical \texttt{Damage}, but you can give \texttt{Trauma} if you would have dealt enough damage to cause an \texttt{Injury}. Additionally, ignore armour for \texttt{Injury} calculations.
    ...
    \end{itemize}
You can choose its appearance and keep two pieces of your gear and one weapon.
...
\paragraph{Armour.} Generally, each layer of armour gives an additional armour point, up to \texttt{A4} with shield.
