...
\begin{multicols*}{2}
    ...
    \paragraph{Riposte} is a risky and potentially deadly manoeuvre. Can't use guard or deny. 
    Roll your weapon dice as if you are performing an attack. 
    Choose the amount equal to Focus that you allocated to \emph{Defense}.
    
    You can trade any of your dice for lower dice in the attack roll against you. 
    Deal damage equal to the difference to one of the attackers. 
...
They last for a task you summoned them to fullfil or for one combat. Slowly dissipate when idle.
...
Spell is active for a couple of days or until dismissed. 
...
\paragraph{Blade Ward.} Pick any amount of dice, mark them as spent, but they can't go back to the pool while the spell lasts.
...
Witch can commune with their patron at will as long as their favour is not zero.
Generally patron is helpful, but perseus their own goals and struggles to understand human ways outside of their domain. 
Favour determines how many times a witch can request audience and expect an answer. 
...
\begin{itemize}[nosep, leftmargin=*]
    ...
    As long as you hold the door open, it leads to the place the door you envisioned lead to. 
