...
\newpage
\section*{\centering \fontsize{35}{45}\selectfont More Combat}
\vspace*{0.4 cm}
\label{sec:hopefear}
\begin{multicols*}{2}
    ...
    \paragraph{Fear.} Each time a knight or a friendly npc rolls \texttt{1} on their weapon die or \texttt{20} on a Virtue Save the Company accumulates one point of \texttt{Fear}. 
    ...
    Choose the number of them equal to \texttt{Focus} you allocated to \emph{Defense}, spending one point per dice.
    ...
    Pass \texttt{Spirit} save of become \texttt{Fatigued}.
